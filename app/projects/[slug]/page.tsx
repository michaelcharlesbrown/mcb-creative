...
export default async function Project({
  ...
  return (
    <div className="min-h-screen bg-white text-black">
      <main className="max-w-[2400px] mx-auto p-4">
        {/* Hero Section - Only for BitTorrent */}
        {slug === "bittorrent" && <ProjectHero />}
                ...
                <div key={rowIndex} className="w-full">
                  <div className="relative w-full aspect-video">
                    {mediaItem.mediaType === "image" ? (
                      <Image
                        src={`/images/projects/${project.slug}/${mediaItem.src}`}
                      ...
                      <video
                        src={`/video/projects/${project.slug}/${mediaItem.src}`}
                        autoPlay
                        loop
                        muted
                        playsInline
