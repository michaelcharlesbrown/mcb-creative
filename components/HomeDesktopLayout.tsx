...
export default function HomeDesktopLayout({ projects }: HomeDesktopLayoutProps) {
  ...
  return (
    <div className="bg-background">
      ...
      {/* Featured Work */}
      <div className="bg-background">
        <div className="max-w-[var(--content-max-width)] mx-auto content-inset pt-[calc(100px+max(var(--nav-height),4rem))] pb-[calc(100px+4rem)] md:pt-[calc(100px+max(var(--nav-height),6rem))] md:pb-[calc(100px+6rem)]">
