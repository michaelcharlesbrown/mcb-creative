    ...
    >
      <div className="w-full max-w-[var(--content-max-width)] mx-auto content-inset">
        <div className="w-full grid grid-cols-12 gap-x-4 md:gap-x-[clamp(1rem,2vw,2rem)]">
          <p className="about-blurb__text col-span-12 md:col-span-7 md:col-start-5 uppercase font-normal text-left max-w-[calc(100%-35px)]">
            {mainText}
            <br /><br />
            <span className="about-blurb__location">{locationText}</span>
          </p>
        </div>
      </div>
    </section>
